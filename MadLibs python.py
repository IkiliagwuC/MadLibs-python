#code for the madlibs using the tkinter GUI
...
#place() used to place widgets in a specific position
...
def madlib1():
    ...
    print('say ' + food + ', the photographer said as the camera flashed! '
        ...
        + profession + '. when we saw the second photo, it was exactly what I wanted.We both looked like ' + things + ' wearing ' + cloth +
...
def madlib2():
    ...
    print('Last night I dreamed I was a ' +adjactive+
          ' butterfly with ' + color+ ' splocthes that looked like '+thing+
          ' .I flew to ' + place+ ' with my bestfriend and '+person+ ' who wasa '+adjactive1+ ' ' +insect + '.We ate some ' + food + ' when we got thereand then decided to'  +verb+ 'and the dream ended when I said-- lets' +verb )
...
#mainloop used to make the tkinter window stay on the screen
root.mainloop()
